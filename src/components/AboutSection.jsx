  ...
  return (
    <div className="bg-rosa-forte flex flex-col md:flex-row-reverse justify-center items-center p-6 md:p-10 lg:px-20 gap-15">
      <div className='max-w-[500px]'>
        <h2 className="text-verde-vibrante font-semibold">Sobre nós:</h2>
        ...
        <div className='items-center justify-center flex flex-col'>
          ...
          <div className='bg-verde-primario hover:bg-verde-escuro w-[230px] h-[40px] flex items-center justify-center text-sm font-medium rounded-md mt-4'>
