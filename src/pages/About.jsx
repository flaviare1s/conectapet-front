    ...
    <div className="flex flex-col flex-grow items-center justify-center mb-15 max-w-[1200px] mx-auto">
      <div className="self-end pr-6">
        ...
        <div className="flex flex-col flex-grow items-center justify-center">
          <h1 className="text-verde-primario text-center text-2xl md:text-5xl p-4 font-bold">Nossa missão</h1>
          <p className="md:text-2xl text-justify px-10 pb-5">
          ...
          <ul className="text-left md:text-xl">
            <li className="mb-10">
              ...
              <ul className="list-disc list-outside px-10 text-left md:text-xl mx-auto">
                ...
                <li>Preencha os campos nome, email e senha (com no mínimo 6 dígitos).</li>
            ...
            <li className="mb-10">
              ...
              <ul className="list-disc list-outside px-10 text-left md:text-xl mx-auto">
                ...
                <li>Na página "Pets", você encontrará várias opções de animais disponíveis para adoção. Fique atento ao status de adoção, exibido no canto superior esquerdo de cada card.</li>
                <li>Ao escolher o pet que mais gostar, você será direcionado para o perfil dele.</li>
